     ...
     <center><div>
      ...
      <div>
        <div style={{ position: 'relative', display: 'inline-block' }}>
          <img src={desk} style={{ position: 'absolute', top: '65px', left:'350px',width:"865px" }} alt="mockup" />
          <img src={mockup} style={{ position: 'absolute', top: '100px', left: '400px' }} alt="desk" />
        </div>
        <div style={{ position: 'relative', display: 'inline-block' }}>
          <img src={mobile} style={{ position: 'absolute', top:'155px', left: '360px' }} alt="mobile" />
          <img src={mobilemock} style={{ position: 'absolute', top: '150px', left: '350px' }} alt="mobilemock" />
        </div>
      </div>
